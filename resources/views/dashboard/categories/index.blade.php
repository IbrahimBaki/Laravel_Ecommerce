        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{__('admin/general.categories')}} </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/general.main')}}</a></li>
                                <li class="breadcrumb-item active"> {{__('admin/general.categories')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin/general.catAll')}} </h4>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('admin/general.catParent')}}</th>
                                                <th> {{__('admin/general.slug')}}</th>
                                                <th>{{__('admin/general.status')}}</th>
                                                <th>{{__('admin/general.catPhoto')}}</th>

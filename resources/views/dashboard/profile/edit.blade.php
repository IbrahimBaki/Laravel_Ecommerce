                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/profile.editProfile')}} </h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form" action="{{route('update.profile',$admin->id)}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> {{__('admin/profile.general')}} </h4>
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> {{__('admin/profile.securityLogin')}} </h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/profile.confirmPassword')}} </label>
                                                            <input type="password"
                                                                   class="form-control"
